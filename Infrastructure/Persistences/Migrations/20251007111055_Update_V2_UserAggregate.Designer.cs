...
namespace Infrastructure.Persistences.Migrations
{
    ...
    [Migration("20251007111055_Update_V2_UserAggregate")]
    partial class Update_V2_UserAggregate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.AggregatesModel.UserAggregate.UserVerificationToken", b =>
                {
                    b.HasOne("Domain.AggregatesModel.UserAggregate.User", null)
                        .WithOne("CurrentVerificationToken")
                        .HasForeignKey("Domain.AggregatesModel.UserAggregate.UserVerificationToken", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
