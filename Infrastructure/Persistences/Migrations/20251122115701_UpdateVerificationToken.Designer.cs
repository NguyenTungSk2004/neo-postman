...
namespace Infrastructure.Persistences.Migrations
{
    ...
    [Migration("20251122115701_UpdateVerificationToken")]
    partial class UpdateVerificationToken
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.AggregatesModel.VerificationAggregate.UserVerificationToken", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.AggregatesModel.VerificationAggregate.UserVerificationToken", b =>
                {
                    b.HasOne("Domain.AggregatesModel.UserAggregate.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
